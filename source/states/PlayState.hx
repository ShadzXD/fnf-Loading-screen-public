...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.visible = updateTime = false;
		...
		healthBar = new HealthBar(0, FlxG.height * (!ClientPrefs.data.downScroll ? 0.91 : 0.11), 'healthBar', function() return health, 0, 2);
	...
	public function endSong()
	{
		...
		{
			var beatenweek:String = WeekData.getWeekFileName() + '_beaten';
			var achieve:String = checkForAchievement([beatenweek, 'debugger']);
			if(achieve != null) {
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var placement:Float =  FlxG.width * 0.5;
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled && Achievements.getAchievementIndex(achievementName) > -1) {
				...
				if (achievementName == WeekData.getWeekFileName() + '_beaten') // any FC achievements, name should be "weekFileName_nomiss", e.g: "week3_nomiss";
				{
